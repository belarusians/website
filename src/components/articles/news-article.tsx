...
export function NewsArticle(props: ArticleProps) {
  return (
    <div className="rounded-md shadow-lg">
      ...
      <div
        className="max-w-full prose-sm md:prose prose-hr:my-4 prose-a:text-red prose-a:break-words prose-blockquote:border-l-2 prose-blockquote:border-red px-4 lg:px-8 pb-4 lg:pb-8 my-8 md:my-4"
