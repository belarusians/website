...
import { github, footer, disclaimer } from "./footer.css";
...
export function Footer(props: HTMLAttributes<HTMLElement>): JSX.Element {
  return (
    <div className={`${props.className} ${footer}`}>
      ...
      <a className={github} href="https://github.com/belarusians/website"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="32" height="32" viewBox="0 0 32 32">
